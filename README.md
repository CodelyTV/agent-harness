...
| Skill                                                             | What it does                                                                                              |
|-------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|
| [`codely-git-conventional_commit`](.agents/skills/codely-git-conventional_commit/SKILL.md) | Creates a Git commit following the team's Conventional Commits conventions and co-author trailer. |
